...
class Printer:
    ...
    def __print_cumulated_commits_over_time_by_author(self, numstat):
        ...
        print(self.__formatter.h2("Cumulated commits over time by author"), file=self.__file)
    ...
    def __print_impacts_over_time(self, numstat):
        print(self.__formatter.section(), file=self.__file)
        print(self.__formatter.h2("Impacts over time"), file=self.__file)
    ...
    def __print_commits_over_time_by_author(self, numstat):
        print(self.__formatter.section(), file=self.__file)
        print(self.__formatter.h2("Commits over time by authors"), file=self.__file)
        header, data = gitstatsLib.count_commits_over_month_by_author(numstat)
        header = replace_author_row(header)
        if len(data) > 12:
            data_a = data[:-12]
    ...
    def __print_cemetery(self):
        ...
        print(self.__formatter.table(header, [data], md="|%s|" % "|".join([":---:"] * len(header))),
              file=self.__file)  # gravestone
        print(self.__formatter.section(), file=self.__file)
    ...
    def __print_commits_by_committer(self, numstat):
        print(self.__formatter.section(), file=self.__file)
        print(self.__formatter.h2("Thieves (commits on behalf of) (only active committers/authors)"), file=self.__file)
    ...
    def __print_reviews(self, numstat):
        ...
        if not reviewer_regex:
            return
        print(self.__formatter.section(), file=self.__file)
        print(self.__formatter.h2("Reviews (only active reviewers/authors)"), file=self.__file)
    ...
    def __print_edited_lines_of_code_by_author(self, numstat, blame):
        print(self.__formatter.section(), file=self.__file)
        print(self.__formatter.h2("Edited lines of code by author"), file=self.__file)
    ...
    def __print_other(self, items):
        print(self.__formatter.section(), file=self.__file)
        print(self.__formatter.h2("Other statistics"), file=self.__file)
        ...
        for j in range(4):
            ...
            for i in range(0, len(items), 4):
                if i + j >= len(items):
                    break
                print(self.__formatter.card(items[i + j][0], items[i + j][1], items[i + j][2]), file=self.__file)
            print(self.__formatter.column(), file=self.__file)
        print(self.__formatter.section(), file=self.__file)
